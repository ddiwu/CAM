...
TARGET := hw
VPP_LDFLAGS := --kernel_frequency 300
include ./utils.mk
...
# Building kernel
$(BUILD_DIR)/cam.xclbin: $(TEMP_DIR)/rtl_cam.xo $(TEMP_DIR)/mem_read.xo $(TEMP_DIR)/mem_write.xo $(TEMP_DIR)/increment.xo $(TEMP_DIR)/register_slice.xo
	mkdir -p $(BUILD_DIR)
